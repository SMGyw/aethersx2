...
elseif (ANDROID)
	...
	add_subdirectory(3rdparty/wxwidgets3.0 EXCLUDE_FROM_ALL)
	add_subdirectory(3rdparty/xz EXCLUDE_FROM_ALL)
	add_subdirectory(3rdparty/libaio EXCLUDE_FROM_ALL)
	...
	if (NOT PCSX2_CORE)
		...
		if(CMAKE_CROSSCOMPILING)
			...
			if(${PCSX2_TARGET_ARCHITECTURES} STREQUAL "aarch64")
				set(wxWidgets_CONFIG_EXECUTABLE "/opt/aarch64-chroot/usr/lib/aarch64-linux-gnu/wx/config/gtk3-unicode-3.0")
...
if(NOT TARGET PkgConfig::SOUNDTOUCH)
    add_library(PkgConfig::SOUNDTOUCH INTERFACE IMPORTED)
endif()
	# --- Forced Mock for SAMPLERATE ---
set(SAMPLERATE_FOUND TRUE)
set(SAMPLERATE_LIBRARIES "")
set(SAMPLERATE_INCLUDE_DIRS "")

if(NOT TARGET PkgConfig::SAMPLERATE)
    add_library(PkgConfig::SAMPLERATE INTERFACE IMPORTED)
endif()
